...
void setup() {
 DigiKeyboard.sendKeyStroke(0);
  ...
  DigiKeyboard.sendKeyStroke(KEY_ENTER);
  DigiKeyboard.delay(500);
  DigiKeyboard.print("$client.DownloadFile( \" https://static.wikia.nocookie.net/alba-momo/images/9/97/Doge.jpg/revision/latest?cb=20200516170419&path-prefix=it \" , \" doge.jpg \")");
  DigiKeyboard.sendKeyStroke(KEY_ENTER);
  DigiKeyboard.delay(500);
